...
if latest_image:
    ...
    if get_response.status_code == 200:
        ...
        assert chamfer_second['prior_operations'] == 'chamfer', f"倒角第二工序的prior_operations应该是chamfer，实际是{chamfer_second['prior_operations']}"
        ...
        print("\n8. 修复总结:")
        print("   ✓ 倒角第二工序: prior_operations标记为'chamfer'，Tool固定为t11")
